var containerboy, stats, controls, mixer, mixer2, clock,clock2,action, currentlyAnimating, raycaster, action2;
...
function init() {
	...
	containerboy = document.createElement( 'div' );

	document.body.appendChild( containerboy );
	...
	var loader = new THREE.GLTFLoader().setPath( 'dad/' );
	...
	*/
	...
	containerboy.appendChild( renderer.domElement );
